	...
	return (
		<section className={'mt-4 grid w-full grid-cols-1 gap-10 pb-10 md:mt-20 md:grid-cols-2'}>
			<div className={'w-full bg-neutral-100 p-10'}>
				<div
					aria-label={'Win the curve wars with Yearn'}
				...
				<div aria-label={'Win the curve wars with Yearn details'}>
					...
					<p className={'text-neutral-600'}>
						...
						<a
							href={'https://docs.yearn.fi/getting-started/products/ylockers/ycrv/overview'}
							target={'_blank'}
							className={'text-neutral-900 underline'}
							rel={'noreferrer'}>
							{'docs'}
			...
			<div className={'w-full bg-neutral-100 p-10'}>
				<div
					aria-label={'Swap anytime for better yield'}
					className={'flex flex-col pb-6'}>
			...
			<div className={'w-full bg-neutral-100 p-10'}>
				<div
					aria-label={'Better tokens, better yield'}
					className={'flex flex-col pb-6'}>
			...
			<div className={'w-full bg-neutral-100 p-10'}>
				<div
					aria-label={'“But ser... I have yveCRV and yvBOOST”'}
					className={'flex flex-col pb-6'}>
			...
			<div className={'w-full bg-neutral-100 p-10'}>
				<div
					aria-label={'‘Mum... where do yields come from?’'}
					className={'flex flex-col pb-6'}>
				...
				<div aria-label={'‘Mum... where do yields come from?’ details'}>
					...
					<b>{'lp-yCRV'}</b>
					<p className={'pb-6 text-neutral-600'}>{'The yields come from farming the CRV/yCRV gauge. '}</p>
					<p className={'text-neutral-600'}>
						{
